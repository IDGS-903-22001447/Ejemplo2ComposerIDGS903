...
fun Calculadora(){
    ...
    val (selectedOption, onOptionSelected) = remember { mutableStateOf(radioOptions[0]) } // Default to "Suma"
    ...
    Column (modifier = Modifier
        ...
        // Integrate RadioButtonSingleSelection
        ...
        Button(
            onClick = {
                val n1 = num1.toDoubleOrNull() // Use Double for potential decimal results
